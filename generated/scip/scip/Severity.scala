...
sealed abstract class Severity(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  def companion: _root_.scalapb.GeneratedEnumCompanion[Severity] = scip.scip.Severity
  final def asRecognized: _root_.scala.Option[scip.scip.Severity.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[scip.scip.Severity.Recognized])
}
...
object Severity extends _root_.scalapb.GeneratedEnumCompanion[Severity] {
  ...
  lazy val values = scala.collection.immutable.Seq(UnspecifiedSeverity, Error, Warning, Information, Hint)
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = ScipProto.javaDescriptor.getEnumTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = ScipProto.scalaDescriptor.enums(4)
}